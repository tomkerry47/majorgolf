import { z } from "zod";
import { pgTable, serial, varchar, text, boolean, timestamp, integer, date, uniqueIndex } from "drizzle-orm/pg-core"; // Added uniqueIndex
...
export const selectionFormSchema = insertSelectionSchema
    ...
    .refine(data => new Set([data.golfer1Id, data.golfer2Id, data.golfer3Id]).size === 3, {
