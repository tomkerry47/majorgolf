import { 
  users, competitions, golfers, selections, results,
...
// Implementation of IStorage interface using Drizzle ORM
export class DatabaseStorage implements IStorage {
  ...
  async getUserSelections(userId: number, competitionId: number): Promise<Selection | undefined> {
    ...
    // Note: This doesn't include the nested golfer data that Supabase provides
    // To get similar behavior, we would need to perform additional queries
